...
module.exports = {
    name: "unhide",
    description: "Réaffiche le salon",
    ...
    run: async (client, message, args, cmd) => {
        ...
        if (perm == true) {
            ...
            await channel.permissionOverwrites.edit(message.guild.id, { VIEW_CHANNEL: true }).then(() => {
                return message.reply(":white_check_mark: La salon a été réaffiché.")
            }).catch(e => {message.reply(`:x: Je n'ai pas pu réafficher le salon`)})
            ...
            if (logchannel) logchannel.send({
                embeds: [new Discord.MessageEmbed()
                    ...
                    .setDescription(`${message.author} a **unhide** le salon ${channel}`)]
            }).catch(e => { e })
