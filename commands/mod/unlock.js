...
module.exports = {
  ...
  run: async (client, message, args, cmd) => {
    ...
    if (perm == true) {
      ...
      await channel.permissionOverwrites.edit(message.guild.id, { SEND_MESSAGES: true }).then(() =>{
        message.reply(":white_check_mark: Le salon a été ouvert.")
    })
      ...
      if (logchannel) logchannel.send({
        embeds: [new Discord.MessageEmbed()
          ...
          .setDescription(`${message.author} a **unlock** le salon ${channel}`)]
      }).catch(e => { e })
