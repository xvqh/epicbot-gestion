...
module.exports = {
    name: "skip",
    description: "Affiche les musiques suivantes",
    ...
    run: async (client, message, args, cmd) => {
        ...
        if (perm == true) {
            ...
            guildQueue.skip();
            if (!guildQueue) message.guild.me.voice.channel.stop();
                
            var embed = new Discord.MessageEmbed()
                .setDescription(`J'ai skip [${currentTrack.name}](${currentTrack.url}) !`)
